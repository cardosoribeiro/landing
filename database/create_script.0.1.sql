...
CREATE TABLE instructor (
    ...
    FOREIGN KEY (id_user) REFERENCES users(id_user) ON DELETE SET NULL -- Foreign key constraint to users table
);
...
-- Example of inserting a user (IMPORTANT: Hash the password before storing it!)
--  REPLACE with a properly hashed password using a library like BCrypt.
INSERT INTO users (username, password, role) VALUES ('testuser', '$2a$10$SOME_HASHED_PASSWORD', 'student');
INSERT INTO users (username, password, role) VALUES ('instructor', '$2a$10$SOME_HASHED_PASSWORD', 'instructor');